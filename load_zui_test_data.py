...
def pull_modify_push_image(logger, registry, image_name, tag, cosign_password, multiarch, username, password, debug):
    ...
    with tempfile.TemporaryDirectory() as meta_dir_name:
        ...
        cmd = ["./build_push_image_regctl.sh", "-r", registry, "-i", image_name, "-t", tag, "-c", cosign_password,
...
def main():
    ...
    for image in config["images"]:
        ...
        for tag in expected_tags:
            image_metadata = pull_modify_push_image(logger, registry, image_name, tag, cosign_password, multiarch, username, password, debug)
